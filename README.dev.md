...
└── package.json    # Quản lý backend/frontend workspaces
```
...
_Lệnh này sẽ tự động cài đặt thư viện cho Backend, Frontend và thiết lập hệ thống bảo vệ Husky._
...
Mobile app đã tách sang repo riêng:

```text
https://github.com/HUFI-Last-Dance/ReviewLecturers-Mobile
```

Repo tổng này chỉ giữ Backend + Frontend. Mobile release dùng GitHub Releases trong repo mobile riêng, không commit APK vào repo tổng.
...
- **Mobile:** repo riêng `HUFI-Last-Dance/ReviewLecturers-Mobile`, release APK bằng GitHub Releases.
