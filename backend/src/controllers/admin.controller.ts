...
export const getSystemStats = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  const [totalUsers, totalLecturers, totalSubjects, totalReviews, totalReplies, pendingLecturers] =
    await Promise.all([
      prisma.user.count(),
 ...
 * Xóa role khỏi user
 */
export const removeRole = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
 ...
 * Body: { userId: "uuid" }
 */
export const verifyLecturer = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
 ...
 * Hủy verify lecturer
 */
export const unverifyLecturer = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  const { lecturerId } = req.params;
