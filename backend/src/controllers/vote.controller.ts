 ...
 */
export const voteReview = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
 ...
 * Body: { voteType: "UPVOTE" | "DOWNVOTE" }
 */
export const voteReply = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
 ...
 */
export const getMyReviewVote = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  const { reviewId } = req.params;
  const userId = req.user!.userId;
 ...
 */
export const getMyReplyVote = async (req: AuthenticatedRequest, res: Response): Promise<void> => {
  const { replyId } = req.params;
  const userId = req.user!.userId;
