...
export function VoteButtons({ id, type, initialUp, initialDown, initialUserVote }: VoteButtonsProps) {
        ...
        <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 rounded-lg p-1 border-2 border-slate-200 dark:border-slate-700">
            <button
                ...
                className={cn(
                    ...
                    userVote === 'UPVOTE' ? "text-orange-600 dark:text-orange-400 bg-slate-100 dark:bg-slate-700" : "text-slate-500 dark:text-slate-400"
                )}
            >
            ...
            <button
                ...
                className={cn(
                    "flex items-center gap-1 px-2 py-1 rounded text-xs font-bold transition-colors hover:bg-slate-100 dark:hover:bg-slate-700",
                    userVote === 'DOWNVOTE' ? "text-blue-600 dark:text-blue-400 bg-slate-100 dark:bg-slate-700" : "text-slate-500 dark:text-slate-400"
                )}
            >
