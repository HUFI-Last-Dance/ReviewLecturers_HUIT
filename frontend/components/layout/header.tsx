                    ...
                    {navItems.map((item) => (
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive(item.href) ? 'text-blue-600 dark:text-blue-400' : 'text-slate-600 dark:text-slate-300'
                            )}
                        >
                            {item.label}
                        </Link>
                        ...
                        <>
                            {user ? (
                                ...
                                <div className="flex items-center gap-2">
                                    <Link href="/login">
                                        <Button variant="ghost" size="sm" className="dark:text-slate-300 dark:hover:text-white dark:hover:bg-slate-800">
                                            {t('common.login')}
                                        </Button>
                                    </Link>
                                    <Link href="/register">
