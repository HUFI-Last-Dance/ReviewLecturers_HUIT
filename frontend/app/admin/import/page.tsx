...
export default function ImportPage() {
  const [dataType, setDataType] = useState<'lecturers' | 'subjects' | 'terms' | 'assignments'>(
    'lecturers',
  );
      ...
      <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 flex items-start gap-3">
        ...
        <div className="text-sm text-blue-800">
          ...
          <ul className="list-disc pl-4 space-y-1">
            <li>
              <strong>Lecturers:</strong> fullName*, staffId*, degreeCode (CN/ThS/TS/PGS/GS)
            </li>
            <li>
              <strong>Subjects:</strong> code*, name*, credits
            </li>
            <li>
              <strong>Terms:</strong> code* (VD: HK1_2425), name*, startDate, endDate
            </li>
            <li>
              <strong>Assignments:</strong> lecturerStaffId*, subjectCode*, termCode*, classCode
            </li>
          </ul>
          <p className="mt-2 text-blue-600 text-xs">
            * = bắt buộc. Xem IMPORT_TEMPLATES.md để có mẫu JSON chi tiết.
          </p>
        </div>
      </div>
    </div>
