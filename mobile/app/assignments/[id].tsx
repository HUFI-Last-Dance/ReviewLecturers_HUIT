  ...
  if (isError || !assignment) {
    return (
      <View style={[styles.errorContainer, { backgroundColor: colors.background }]}>
        <Text style={[styles.errorText, { color: colors.error }]}>Không thể tải thông tin</Text>
    ...
    >
      ...
      >
          ...
          <Card variant="elevated" padding="lg" style={styles.infoCard}>
            ...
            <View style={styles.infoRow}>
              <View style={styles.infoItem}>
                <Text style={[styles.infoLabel, { color: colors.textSecondary }]}>Giảng viên</Text>
                <Text style={[styles.infoValue, { color: colors.text }]}>
                  {assignment.lecturer?.fullName}
                </Text>
              </View>
              <View style={styles.infoItem}>
                <Text style={[styles.infoLabel, { color: colors.textSecondary }]}>Học kỳ</Text>
                <Text style={[styles.infoValue, { color: colors.text }]}>
        ...
        >
          ...
          >
            <User size={20} color={isAnonymous ? colors.primary : colors.textMuted} />
          </TouchableOpacity>
          <TextInput
            style={[
              styles.textInput,
