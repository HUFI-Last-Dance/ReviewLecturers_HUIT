                ...
                <Card variant="elevated" padding="lg" style={styles.headerCard}>
                    <View style={styles.headerTop}>
                        ...
                        <TouchableOpacity style={[styles.bookmarkButton, { borderColor: colors.border }]}>
                            <Bookmark size={20} color={lecturer.isBookmarked ? colors.primary : colors.textSecondary} />
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.voteContainer}>
                        <TouchableOpacity
                            style={[
                                styles.voteButton,
                                {
                                    backgroundColor: lecturer.myVote === 'UPVOTE'
                                        ? colors.upvote + '20'
                                        : colors.surface,
                                    borderColor: lecturer.myVote === 'UPVOTE'
                                        ? colors.upvote
                                        : colors.border,
                                }
                            ]}
                        ...
                        <TouchableOpacity
                            style={[
                                styles.voteButton,
                                {
                                    backgroundColor: lecturer.myVote === 'DOWNVOTE'
                                        ? colors.downvote + '20'
                                        : colors.surface,
                                    borderColor: lecturer.myVote === 'DOWNVOTE'
                                        ? colors.downvote
                                        : colors.border,
                                }
                            ]}
